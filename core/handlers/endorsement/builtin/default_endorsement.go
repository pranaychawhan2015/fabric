...
func (e *DefaultEndorsement) Endorse(prpBytes []byte, sp *peer.SignedProposal) (*peer.Endorsement, []byte, error) {
	...
	return nil, nil, errors.Errorf("could not find the required endorser for the decryption")
...
func CheckEndorsers(inputString string, Pub_key1 *ecdsa.PublicKey, Pub_key2 *ecdsa.PublicKey) bool {
